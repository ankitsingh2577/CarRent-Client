...
<title>Wheels on Rent | My Feedbacks</title>
<!--Bootstrap -->
  ...
  <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        ...
        <div class="profile_wrap">
          <h5 class="uppercase underline">My Feedbacks </h5>
              ...
              <li>
                ...
                <?php if($result->status==1){ ?>
                 <div class="vehicle_status"> <a class="btn outline btn-xs active-btn">Active</a>
                  ...
                  <?php } else {?>
               <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Admin has blocked for feedback</a>
                  <div class="clearfix"></div>
                  </div>
                  <?php } ?>
              </li>
