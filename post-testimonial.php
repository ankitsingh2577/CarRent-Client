...
$sql="INSERT INTO  tbltestimonial(ip,UserEmail,Testimonial,status) VALUES(:ip,:email,:testimonoial,'1')";
...
<title>Wheels on Rent | Post Feedback</title>
<!--Bootstrap -->
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Post a Feedback</h5>
            <?php if($error){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($error); ?> </div><?php } 
