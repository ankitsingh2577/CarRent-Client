...
<title>Wheels on Rent | Car Listing</title>
<!--Bootstrap -->
...
{  ?>
        <div class="product-listing-m gray-bg">
          <div class="product-listing-img"><img src="assets/images/vehicleimages/<?php echo htmlentities($result->Vimage);?>" class="img-responsive" alt="Image" /> </a> 
          </div>
...
<option value="CNG">CNG</option>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Recently Added Cars</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                <div class="recent_post_img"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="assets/images/vehicleimages/<?php echo htmlentities($result->Vimage);?>" alt="image"></a> </div>
